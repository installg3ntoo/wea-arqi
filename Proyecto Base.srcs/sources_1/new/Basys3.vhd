...
signal msout       : std_logic_vector(15 downto 0);
signal usout       : std_logic_vector(15 downto 0);
signal CPU_MuxIn : std_logic_vector(15 downto 0); 

signal btn_1       : std_logic_vector(15 downto 0);
...
MuxIN1: MUXIN port map(
    ...
    useg       => usout,                
    ram       => ram_dataout,             
    ram_dataout     => ram_address,
    OUTPUT     => CPU_MuxIn               
        );
        
DeMuxOut1: DeMuxOut port map( write_ram => write_ram,
           ram_address => ram_address,
           Load_Dis => Load_Dis,
           Load_Led => Load_Led,
           Load_Lcd => Load_Lcd
...
-- Fin de declaración de comportamientos.
  btn_1 <= "00000000000" & d_btn;
  lcd <= Load_Lcd & ram_datain(9 downto 0); -- Linea troll, ayudantes pajeros
